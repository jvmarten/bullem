...
const AUDIO_FILE_SOUNDS: Partial<Record<SoundName, { url: string; gain: number; fadeOut?: number; playbackRate?: number }>> = {
  ...
  bullCalled:  { url: bullCalledUrl, gain: 0.9 },
  trueCalled:  { url: trueCalledUrl, gain: 0.7 },
  callMade:    { url: callMadeUrl, gain: 0.7 },
  ...
  uiClick:     { url: uiClickUrl, gain: 0.85 },
  uiSoft:      { url: uiSoftUrl, gain: 0.9 },
  uiBack:      { url: uiSoftUrl, gain: 0.6, playbackRate: 0.75 },
  ...
  victory: { url: victoryUrl, gain: 0.12, fadeOut: 1.5 },
};
