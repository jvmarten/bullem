        ...
        >
          ...
          >
            ...
            <ul className="text-xs text-left text-[var(--gold-dim)] space-y-1 mt-2 list-disc list-inside">
              <li>Clockwise turn timer on player tiles</li>
              <li>Player profile stats on avatar tap</li>
              <li>Auto-bull sound effect on timer expiry</li>
              <li>Pause/resume timer fix</li>
              <li>Match stats polish</li>
            </ul>
          </div>
        </div>
      )}
