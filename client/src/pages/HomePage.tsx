    ...
    <Layout largeTitle={mode === 'menu'}>
      ...
      {showVersion && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-bold text-[var(--gold)]">Bull &apos;Em v1.3.0</h3>
            ...
            <ul className="text-xs text-left text-[var(--gold-dim)] space-y-1 mt-2 list-disc list-inside">
              <li>Deck draw animated card reveal with sound effects</li>
              <li>Deck draw custom wager amounts (1, 5, 10, 50, 100)</li>
              <li>Deck draw balance shown in player profile</li>
              <li>Emoji menu stays open when sending reactions</li>
              <li>Chat and emoji button visibility fix</li>
            </ul>
          </div>
        </div>
      )}
