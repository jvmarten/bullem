    ...
    <Layout largeTitle>
      ...
      {showVersion && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-bold text-[var(--gold)]">Bull &apos;Em v1.2.9</h3>
            ...
            <ul className="text-xs text-left text-[var(--gold-dim)] space-y-1 mt-2 list-disc list-inside">
              <li>Fixed leave game button not working during reconnection</li>
              <li>Username changes now update across match history</li>
            </ul>
          </div>
        </div>
      )}
