export { decideCFR, decideCFRWithSearch, setCFRStrategyData, isCFRStrategyLoaded, decodeCFRCompact, getCFRStrategyStats, resetCFRStrategyStats } from './cfrEval.js';
export type { StrategyEntry, SearchConfig, CompactCFRStrategy } from './cfrEval.js';
